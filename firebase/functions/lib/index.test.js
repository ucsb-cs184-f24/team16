...
(0, globals_1.test)("test-get-calendars", async () => {
    ...
    (0, globals_1.expect)(calendarsResponse.status).toBe(constants_1.Status.OK);
    if (calendarsResponse.status === constants_1.Status.OK) {
...
(0, globals_1.test)("test-get-quarters", async () => {
    ...
    (0, globals_1.expect)(quartersResponse.status).toBe(constants_1.Status.OK);
    if (quartersResponse.status === constants_1.Status.OK) {
